var CardFilter = Class.extend({
    ...
    buildUi: function (elem, pageElem) {
        ...
        this.setSelect = $("<select style='width: 130px; font-size: 80%;'>"
            + "<option value='0-33'>All Sets</option>"
            + "<option value='0-19'>Official Sets</option>"
            + "<option value='30-33'>The Hobbit Sets</option>"
            + "<option value='50-89'>Player's Council Errata</option>"
            + "<option value='101-200'>Player's Council VSets</option>"
            + "<option value='50-89,101-200'>All Player's Council Cards</option>"
        ...
        this.filterDiv.append("<div id='culture1'>"
            + "<input type='checkbox' id='SHIRE'/><label for='SHIRE' id='labelSHIRE' title='Shire'><img src='images/cultures/shire.png'/></label>"
            + "<input type='checkbox' id='GANDALF'/><label for='GANDALF' id='labelGANDALF' title='Gandalf'><img src='images/cultures/gandalf.png'/></label>"
            + "<input type='checkbox' id='GONDOR'/><label for='GONDOR' id='labelGONDOR' title='Gondor'><img src='images/cultures/gondor.png'/></label>"
            + "<input type='checkbox' id='ELVEN'/><label for='ELVEN' id='labelELVEN' title='Elven'><img src='images/cultures/elven.png'/></label>"
            + "<input type='checkbox' id='ROHAN'/><label for='ROHAN' id='labelROHAN' title='Rohan'><img src='images/cultures/rohan.png'/></label>"
            + "<input type='checkbox' id='DWARVEN'/><label for='DWARVEN' id='labelDWARVEN' title='Dwarven'><img src='images/cultures/dwarven.png'/></label>"
            + "<input type='checkbox' id='GOLLUM'/><label for='GOLLUM' id='labelGOLLUM' title='Gollum'><img src='images/cultures/gollum.png'/></label>"
            + "</div>");
        this.filterDiv.append("<div id='culture2'>"
            + "<input type='checkbox' id='WRAITH'/><label for='WRAITH' id='labelWRAITH' title='Wraith'><img src='images/cultures/wraith.png'/></label>"
            + "<input type='checkbox' id='MORIA'/><label for='MORIA' id='labelMORIA' title='Moria'><img src='images/cultures/moria.png'/></label>"
            + "<input type='checkbox' id='ISENGARD'/><label for='ISENGARD' id='labelISENGARD' title='Isengard'><img src='images/cultures/isengard.png'/></label>"
            + "<input type='checkbox' id='DUNLAND'/><label for='DUNLAND' id='labelDUNLAND' title='Dunland'><img src='images/cultures/dunland.png'/></label>"
            + "<input type='checkbox' id='RAIDER'/><label for='RAIDER' id='labelRAIDER' title='Raider'><img src='images/cultures/raider.png'/></label>"
            + "<input type='checkbox' id='SAURON'/><label for='SAURON' id='labelSAURON' title='Sauron'><img src='images/cultures/sauron.png'/></label>"
            + "<input type='checkbox' id='MEN'/><label for='MEN' id='labelMEN' title='Men'><img src='images/cultures/men.png'/></label>"
            + "<input type='checkbox' id='ORC'/><label for='ORC' id='labelORC' title='Orc'><img src='images/cultures/orc.png'/></label>"
            + "<input type='checkbox' id='URUK_HAI'/><label for='URUK_HAI' id='labelURUK_HAI' title='Uruk-Hai'><img src='images/cultures/uruk_hai.png'/></label>"
            //Additional Hobbit Draft cultures
            + "<input type='checkbox' id='ESGAROTH'/><label for='ESGAROTH' id='labelESGAROTH' title='Esgaroth'><img src='images/cultures/esgaroth.png'/></label>"
            + "<input type='checkbox' id='GUNDABAD'/><label for='GUNDABAD' id='labelGUNDABAD' title='Gundabad'><img src='images/cultures/gundabad.png'/></label>"
