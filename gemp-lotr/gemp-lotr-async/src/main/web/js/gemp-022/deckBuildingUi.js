var GempLotrDeckBuildingUI = Class.extend({
    ...
    init:function () {
        ...
        var pcSplash = $(`<span id="pc-splash" style="float: right; background-color: #444444AA;border: 3px solid #E65014; vertical-align: top; top:-20%; position: relative; width:70%;">
